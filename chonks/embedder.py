"""
embedder.py: OpenAI-compatible /v1/embeddings client plus the embed-path text
compression and retry-classification helpers. See `chunker.py` for the
indexing pipeline that drives it.
"""
...
def _compress_for_embed(text: str, *, name: str | None = None, path: str | None = None) -> str:
